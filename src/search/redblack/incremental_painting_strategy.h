...
public:
	auto generate_next_painting(const Painting &last_painting, const std::vector<OperatorID> &last_plan, const GlobalState &initial_state, const std::vector<bool> *never_black_variables = nullptr) -> Painting;
	virtual auto generate_next_painting(const Painting &last_painting, const std::vector<OperatorID> &last_plan, const GlobalState &initial_state, const std::vector<FactPair> &goal_facts, const std::vector<bool> *never_black_variables = nullptr) -> Painting = 0;
...
public:
	...
	auto generate_next_painting(const Painting &last_painting, const std::vector<OperatorID> &last_plan, const GlobalState &initial_state, const std::vector<FactPair> &goal_facts, const std::vector<bool> *never_black_variables) -> Painting override;
};
